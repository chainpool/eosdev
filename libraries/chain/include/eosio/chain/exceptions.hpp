...
namespace eosio { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( tx_invalid_fee_rate,               eosio::chain::transaction_exception, 3030037, "Transaction fee rate not valid, must be great than or equal to 1.0." )
